...
Public Class Form1
    ...
    Public Sub SearchonPress()
        ...
        Try
            ...
            Dim query As String = "SELECT s.*, c.* FROM student_info s JOIN class_info c ON c.class_id = c.class_id WHERE s.student_id LIKE @searchText"
            ...
            Using selectCommand As New MySqlCommand(selectQuery, con)
                ...
                Using reader As MySqlDataReader = selectCommand.ExecuteReader()
                    ...
                    Else
                        ...
                        MessageBox.Show("TIME IN: Student number does not exist.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
