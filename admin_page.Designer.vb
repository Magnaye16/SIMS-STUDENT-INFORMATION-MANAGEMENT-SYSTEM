...
Partial Class admin_page
    ...
    Private Sub InitializeComponent()
        ...
        Student_data = New Guna.UI2.WinForms.Guna2DataGridView()
        ...
        CType(Student_data, ComponentModel.ISupportInitialize).BeginInit()
        SuspendLayout()
        ' 
        ' Guna2TabControl1
        ' 
        ...
        Guna2TabControl1.Location = New Point(3, 1)
        Guna2TabControl1.Name = "Guna2TabControl1"
        Guna2TabControl1.SelectedIndex = 0
        Guna2TabControl1.Size = New Size(1059, 685)
        ...
        ' TabPage1
        ' 
        TabPage1.Controls.Add(Guna2GradientButton4)
        TabPage1.Controls.Add(Guna2GradientButton3)
        TabPage1.Controls.Add(PictureBox1)
        TabPage1.Controls.Add(Guna2HtmlLabel8)
        TabPage1.Controls.Add(Guna2TextBox8)
        TabPage1.Controls.Add(Guna2HtmlLabel7)
        TabPage1.Controls.Add(Guna2TextBox7)
        TabPage1.Controls.Add(Guna2GradientButton2)
        ...
        TabPage1.Size = New Size(871, 677)
        TabPage1.TabIndex = 0
        TabPage1.Text = "Crud"
        ...
        Guna2GradientButton3.Location = New Point(602, 239)
        ...
        Guna2GradientButton3.TabIndex = 19
        Guna2GradientButton3.Text = "Save"
        ' 
        ' PictureBox1
        ' 
        PictureBox1.Location = New Point(542, 106)
        PictureBox1.Name = "PictureBox1"
        PictureBox1.Size = New Size(309, 101)
        ...
        Guna2HtmlLabel8.Location = New Point(32, 267)
        Guna2HtmlLabel8.Name = "Guna2HtmlLabel8"
        Guna2HtmlLabel8.Size = New Size(45, 17)
        ...
        Guna2TextBox8.Location = New Point(32, 290)
        ...
        Guna2HtmlLabel7.Location = New Point(297, 267)
        Guna2HtmlLabel7.Name = "Guna2HtmlLabel7"
        Guna2HtmlLabel7.Size = New Size(32, 17)
        ...
        Guna2TextBox7.Location = New Point(297, 290)
        ...
        Guna2GradientButton2.Location = New Point(236, 479)
        ...
        Guna2HtmlLabel6.Location = New Point(297, 64)
        ...
        Guna2HtmlLabel5.Location = New Point(297, 134)
        Guna2HtmlLabel5.Name = "Guna2HtmlLabel5"
        Guna2HtmlLabel5.Size = New Size(26, 17)
        Guna2HtmlLabel5.TabIndex = 11
        Guna2HtmlLabel5.Text = "Year"
        ' 
        ' Guna2HtmlLabel4
        ' 
        Guna2HtmlLabel4.BackColor = Color.Transparent
        Guna2HtmlLabel4.Location = New Point(297, 204)
        Guna2HtmlLabel4.Name = "Guna2HtmlLabel4"
        Guna2HtmlLabel4.Size = New Size(42, 17)
        Guna2HtmlLabel4.TabIndex = 10
        Guna2HtmlLabel4.Text = "Section"
        ' 
        ' Guna2HtmlLabel3
        ' 
        Guna2HtmlLabel3.BackColor = Color.Transparent
        Guna2HtmlLabel3.Location = New Point(30, 204)
        ...
        Guna2HtmlLabel2.Location = New Point(30, 134)
        ...
        Guna2HtmlLabel1.Location = New Point(32, 64)
        ...
        Guna2GradientButton1.Location = New Point(236, 412)
        ...
        Guna2GradientButton1.Text = "Create"
        ' 
        ' Guna2TextBox6
        ' 
        ...
        Guna2TextBox6.Location = New Point(297, 227)
        ...
        Guna2TextBox5.Location = New Point(297, 157)
        ...
        Guna2TextBox4.Location = New Point(297, 90)
        ...
        Guna2TextBox3.Location = New Point(30, 227)
        ...
        Guna2TextBox2.Location = New Point(30, 157)
        ...
        Guna2TextBox1.Location = New Point(30, 90)
        ...
        TabPage2.Controls.Add(Student_data)
        TabPage2.Location = New Point(184, 4)
        TabPage2.Name = "TabPage2"
        TabPage2.Padding = New Padding(3)
        TabPage2.Size = New Size(871, 677)
        TabPage2.TabIndex = 1
        TabPage2.Text = "Display Table"
        ' 
        ' Student_data
        ' 
        Student_data.AllowUserToAddRows = False
        Student_data.AllowUserToDeleteRows = False
        DataGridViewCellStyle1.BackColor = Color.White
        Student_data.AlternatingRowsDefaultCellStyle = DataGridViewCellStyle1
        ...
        Student_data.ColumnHeadersDefaultCellStyle = DataGridViewCellStyle2
        Student_data.ColumnHeadersHeight = 17
        Student_data.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.EnableResizing
        Student_data.Columns.AddRange(New DataGridViewColumn() {Column1, Column2, Column3, Column4, Column5, Column6})
        ...
        Student_data.DefaultCellStyle = DataGridViewCellStyle3
        Student_data.GridColor = Color.FromArgb(CByte(231), CByte(229), CByte(255))
        Student_data.Location = New Point(6, 17)
        Student_data.Name = "Student_data"
        Student_data.ReadOnly = True
        Student_data.RowHeadersVisible = False
        Student_data.Size = New Size(849, 499)
        Student_data.TabIndex = 0
        Student_data.ThemeStyle.AlternatingRowsStyle.BackColor = Color.White
        Student_data.ThemeStyle.AlternatingRowsStyle.Font = Nothing
        Student_data.ThemeStyle.AlternatingRowsStyle.ForeColor = Color.Empty
        Student_data.ThemeStyle.AlternatingRowsStyle.SelectionBackColor = Color.Empty
        Student_data.ThemeStyle.AlternatingRowsStyle.SelectionForeColor = Color.Empty
        Student_data.ThemeStyle.BackColor = Color.White
        Student_data.ThemeStyle.GridColor = Color.FromArgb(CByte(231), CByte(229), CByte(255))
        Student_data.ThemeStyle.HeaderStyle.BackColor = Color.FromArgb(CByte(100), CByte(88), CByte(255))
        Student_data.ThemeStyle.HeaderStyle.BorderStyle = DataGridViewHeaderBorderStyle.None
        Student_data.ThemeStyle.HeaderStyle.Font = New Font("Segoe UI", 9F)
        Student_data.ThemeStyle.HeaderStyle.ForeColor = Color.White
        Student_data.ThemeStyle.HeaderStyle.HeaightSizeMode = DataGridViewColumnHeadersHeightSizeMode.EnableResizing
        Student_data.ThemeStyle.HeaderStyle.Height = 17
        Student_data.ThemeStyle.ReadOnly = True
        Student_data.ThemeStyle.RowsStyle.BackColor = Color.White
        Student_data.ThemeStyle.RowsStyle.BorderStyle = DataGridViewCellBorderStyle.SingleHorizontal
        Student_data.ThemeStyle.RowsStyle.Font = New Font("Segoe UI", 9F)
        Student_data.ThemeStyle.RowsStyle.ForeColor = Color.FromArgb(CByte(71), CByte(69), CByte(94))
        Student_data.ThemeStyle.RowsStyle.Height = 25
        Student_data.ThemeStyle.RowsStyle.SelectionBackColor = Color.FromArgb(CByte(231), CByte(229), CByte(255))
        Student_data.ThemeStyle.RowsStyle.SelectionForeColor = Color.FromArgb(CByte(71), CByte(69), CByte(94))
        ' 
        ' Column1
        ' 
        ...
        CType(Student_data, ComponentModel.ISupportInitialize).EndInit()
        ResumeLayout(False)
    End Sub
    ...
    Friend WithEvents Student_data As Guna.UI2.WinForms.Guna2DataGridView
